...
class FieldTypeStringKeywordTest extends TestCase
{
    ...
    {
        $xml = new \SimpleXMLElement('<test type="keyword" index="false" store="false"/>');
    ...
    {
        $xml = new \SimpleXMLElement('<test type="keyword" index="true" store="true"/>');
        $this->fieldType->setXmlConfig($xml);
    ...
    {
        $xml = new \SimpleXMLElement('<test type="keyword" index="true" store="false"/>');
        $this->fieldType->setXmlConfig($xml);
        $this->assertStringMatchesFormat('true', $this->fieldType->getIndex());
        $this->assertStringMatchesFormat('false', $this->fieldType->getStore());
    }
    ...
    {
        $xml = new \SimpleXMLElement('<test type="keyword" index="false" store="true"/>');
        $this->fieldType->setXmlConfig($xml);
        $this->assertStringMatchesFormat('false', $this->fieldType->getIndex());
        $this->assertStringMatchesFormat('true', $this->fieldType->getStore());
    }
